...
def main():
    ...
    # 日付
    add_para(doc, "令和8年4月25日", align=R)
    add_para(doc, "")

    # 宛先
    add_para(doc, "〒665-0035　兵庫県宝塚市逆瀬川1-4-19-202", align=R)
    add_para(doc, "有限会社サラジュ　代表取締役　岩崎真也　殿", align=R)
    add_para(doc, "")

    # 差出人
    add_para(doc, "〒663-8141　兵庫県西宮市高須町1丁目7-15-809", align=R)
    ...
    # 1項目
    add_para(doc, "1．労働条件通知書（または雇用契約書写し）の交付")
    add_para(doc,
    ...
    # 2項目
    add_para(doc, "2．離職票（紙）および退職証明書の交付")
    add_para(doc,
